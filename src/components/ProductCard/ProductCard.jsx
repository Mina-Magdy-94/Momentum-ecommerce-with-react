...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="p-2 col-12 col-md-6 col-lg-4">
            <div className="d-flex flex-column justify-content-between border" style={{ height: '690px' }}>
                <img src={image} className="card-img-top" alt="..." style={{ objectFit: 'cover', width: '100%', height: '400px' }} />
                <div className="d-flex flex-column justify-content-between p-2" style={{ minHeight: '180px' }}>
